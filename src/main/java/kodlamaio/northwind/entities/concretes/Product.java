...
@Entity
// Table notasyonu ise veritabanında hangi tabloya karşılık geldiğini gösterir.
@Table(name = "products")
public class Product {

    @Id //Primary key olduğunu belirtir.
    @GeneratedValue // Burası ise stratejisi belirtir. Yani 50 50 mi artacak ne yapacak bunun gibi.
